...
def location(request):
	...
	return render_to_response('todo_data.html', {'tokens': tokens, 'example_doc': example_doc, 'base_url': base_url, 'location':True}, context_instance=RequestContext(request))
...
def bluetooth(request):
	...
	return render_to_response('todo_data.html', {'tokens': tokens, 'example_doc': example_doc, 'base_url': base_url,  'bluetooth':True}, context_instance=RequestContext(request))
...
def calllog(request):
	...
	return render_to_response('todo_data.html', {'tokens': tokens, 'example_doc': example_doc, 'base_url': base_url, 'calllog': True}, context_instance=RequestContext(request))
...
def sms(request):
	...
	return render_to_response('todo_data.html', {'tokens': tokens, 'example_doc': example_doc, 'base_url': base_url,'sms': True}, context_instance=RequestContext(request))
...
def wifi(request):
	...
	return render_to_response('todo_data.html', {'tokens': tokens, 'example_doc': example_doc, 'base_url': base_url,'wifi':True}, context_instance=RequestContext(request))
...
def likes(request):
	...
	return render_to_response('todo_data.html', {'tokens': tokens, 'example_doc': example_doc,'base_url': base_url, 'likes':True}, context_instance=RequestContext(request))
...
def friends(request):
	...
	return render_to_response('todo_data.html', {'tokens': tokens, 'example_doc': example_doc,'base_url': base_url, 'friends':True}, context_instance=RequestContext(request))
...
def birthday(request):
	...
	return render_to_response('todo_data.html', {'tokens': tokens, 'example_doc': example_doc,'base_url': base_url, 'birthday':True}, context_instance=RequestContext(request))
...
def education(request):
	...
	return render_to_response('todo_data.html', {'tokens': tokens, 'example_doc': example_doc,'base_url': base_url, 'education':True}, context_instance=RequestContext(request))
...
def friendlists(request):
	...
	return render_to_response('todo_data.html', {'tokens': tokens, 'example_doc': example_doc,'base_url': base_url, 'friendlists':True}, context_instance=RequestContext(request))
...
def groups(request):
	...
	return render_to_response('todo_data.html', {'tokens': tokens, 'example_doc': example_doc,'base_url': base_url, 'groups':True}, context_instance=RequestContext(request))
...
def hometown(request):
	...
	return render_to_response('todo_data.html', {'tokens': tokens, 'example_doc': example_doc,'base_url': base_url, 'hometown':True}, context_instance=RequestContext(request))
...
def interests(request):
	...
	return render_to_response('todo_data.html', {'tokens': tokens, 'example_doc': example_doc,'base_url': base_url, 'interests':True}, context_instance=RequestContext(request))
...
def locationfacebook(request):
	...
	return render_to_response('todo_data.html', {'tokens': tokens, 'example_doc': example_doc,'base_url': base_url, 'locationfacebook':True}, context_instance=RequestContext(request))
...
def political(request):
	...
	return render_to_response('todo_data.html', {'tokens': tokens, 'example_doc': example_doc,'base_url': base_url, 'political':True}, context_instance=RequestContext(request))
...
def religion(request):
	...
	return render_to_response('todo_data.html', {'tokens': tokens, 'example_doc': example_doc,'base_url': base_url, 'religion':True}, context_instance=RequestContext(request))
...
def work(request):
	...
	return render_to_response('todo_data.html', {'tokens': tokens, 'example_doc': example_doc,'base_url': base_url, 'work':True}, context_instance=RequestContext(request))
...
def questionnarie(request):
	...
	return render_to_response('questionnaire.html', {'tokens': tokens, 'example_doc': example_doc, 'example_doc2': example_doc2, 'base_url': base_url}, context_instance=RequestContext(request))
